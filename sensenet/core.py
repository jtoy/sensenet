...
from sensenet.utils import closer

env_closer = closer.Closer()

# Env-related abstractions

class SenseEnv(object):
    """The main SenseNet class. It encapsulates an environment with
    ...
    def __new__(cls, *args, **kwargs):
        ...
        env = super(SenseEnv, cls).__new__(cls)
    ...
    def unwrapped(self):
        ...
        Returns:
            sensenet.SenseEnv: The base non-wrapped sensenet.SenseEnv instance
        """
        return self
...
class Space(object):
    ...
    code that applies to any SenseEnv. For example, you can choose a random
    action.
    """
